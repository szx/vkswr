...
pub struct Context {
    ...
    descriptor_sets: HashMap<VkNonDispatchableHandle, Arc<Mutex<descriptor::DescriptorSet>>>,
    framebuffers: HashMap<VkNonDispatchableHandle, Arc<Mutex<pipeline::Framebuffer>>>,
}
    ...
    pub fn format_properties(&self, format: VkFormat) -> VkFormatProperties {
        ...
        match format {
            ...
            VkFormat::VK_FORMAT_R8G8B8A8_UNORM => VkFormatProperties {
                linearTilingFeatures: VkFormatFeatureFlags::from(
